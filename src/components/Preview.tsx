...
const SubtotalComponent = (items: ItemInterface[], descuento: number) => (
  <Box display={"flex"} justifyContent={"flex-end"}>
    <Typography
      fontSize={14}
      sx={{
        textDecoration: descuento > 0 ? "line-through" : "inhertit",
      }}
    >
    ...
    {descuento > 0 && (
      ...
      >
        {FormatoDinero(MontoDescuento(items, descuento))}
      </Typography>
    )}
  </Box>
);
